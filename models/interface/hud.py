...
class HUD:
    ...
    def draw(self, screen: pygame.Surface, is_show_hitbox=True):
        self.active_item.draw(screen, is_show_hitbox=is_show_hitbox)
        self.health.draw(screen,is_show_hitbox=is_show_hitbox)
        self.items.draw(screen, is_show_hitbox=is_show_hitbox)
